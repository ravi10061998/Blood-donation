				...
				<div class="row">
					<div class="col-md-12">
						...
						<p class="text-center pera-text">
							If You save one life, You save a family.Your Blood is Very Precious.More than 38,000 blood donations are needed every day.Every year our nation requires about 12 million units of blood, out of which only 9 million units of blood are available.More than 1 million new people are diagnosed with cancer each year. Many of them will need blood, sometimes daily, during their chemotherapy treatment.
						</p>
    				...
    				<div class="col">
    					<div class="card">
     						<h3 class="text-center red">Our Vission</h3>
								...
								<p class="text-center">
									Children being treated for cancer, premature infants, and children having heart surgery need blood and platelets from donors of all types.The actual blood donation usually takes less than 10 minutes. The entire process, from when you sign in to the time you leave, takes about 45 minutes.The blood donation is the great work and if you donate the blood you can save the 
                                     lifes. Today in the developed world, most blood donors are unpaid volunteers who donate blood for a community supply.
								</p>
						</div>
    				</div>
    				...
    				<div class="col">
    					<div class="card">
      						<h3 class="text-center red">Our Mission</h3>
								...
								<p class="text-center">
								In some countries, established supplies are limited and donors usually give blood when family or friends need a transfusion (directed donation). Many donors donate as an act of charity, but in countries that allow paid donation some donors are paid, and in some cases there are incentives other than money
                                such as paid time off from work. Donors can also have blood drawn for their own future use (autologous donation).
								</p>
							</div>
   			 		</div>
 			</div>
