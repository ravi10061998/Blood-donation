  ...
  if(isset($name) && isset($blood_group) && isset($gender) && isset($day) && isset($month) && isset($year) && isset($email) && isset($contact) && isset($city) && isset($password))
{
  ...
  (name,blood_group,gender,email,city,dob,contact_no,save_life_date,password) 
  VALUES ('$name','$blood_group','$gender','$email','$city','$DonorDOB','$contact','0','$password')";
...
<div class="container size">
         ...
         ?>
          ...
          ?>">
			<?php
              ...
              <input type="numeric" name="contact_no" placeholder="03********" class="form-control" pattern="^\d{11}$" title="11 numeric characters only" maxlength="11" value="<?php
   ...
   <?php 
            ...
            <div class="form-inline">
              <input type="checkbox"  checked="" name="term" value="true" style="margin-left:10px;">
